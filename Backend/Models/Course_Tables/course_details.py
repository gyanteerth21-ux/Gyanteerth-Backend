...
class CourseTable(Base):
    ...
    course_description = Column(String(2000), nullable=False)
    slug = Column(String(100), unique=True, index=True, nullable=True)
    skill_set = Column(String(1000), nullable=False)
    required_knowledge = Column(String(1000), nullable=False)
    benefits = Column(String(1000), nullable=False)
