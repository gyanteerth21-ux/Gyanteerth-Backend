...
async def update_profile(
    ...
    user_number: Annotated[int | None, Form(examples=[1234567890])] = None,
    user_dob: Annotated[date | None, Form(examples=["1990-01-01"])] = None,
    user_gender: Annotated[GenderEnum | None, Form(examples=["male"])] = None,
    user_city: Annotated[str | None, Form(examples=["New York"])] = None,
    user_state: Annotated[str | None, Form(examples=["NY"])] = None,
    user_college: Annotated[str | None, Form(examples=["ABC College"])] = None,
    user_degree: Annotated[str | None, Form(examples=["B.Tech"])] = None,
    user_branch: Annotated[str | None, Form(examples=["Computer Science"])] = None,
    user_year: Annotated[str | None, Form(examples=["3rd Year"])] = None,
