...
async def update_profile(
    ...
    user_number: Annotated[int | None, Form(None, examples=[1234567890])] = None,
    user_dob: Annotated[date | None, Form(None, examples=["1990-01-01"])] = None,
    user_gender: Annotated[GenderEnum | None, Form(None, examples=["male"])] = None,
    user_city: Annotated[str | None, Form(None, examples=["New York"])] = None,
    user_state: Annotated[str | None, Form(None, examples=["NY"])] = None,
    user_college: Annotated[str | None, Form(None, examples=["ABC College"])] = None,
    user_degree: Annotated[str | None, Form(None, examples=["B.Tech"])] = None,
    user_branch: Annotated[str | None, Form(None, examples=["Computer Science"])] = None,
    user_year: Annotated[str | None, Form(None, examples=["3rd Year"])] = None,
...
from schemas.user import CertificateDetailsResponse, CertificateVerifyResponse
...
@router_user.get("/certificate/{certificate_id}/verify", response_model=CertificateVerifyResponse, summary="Verify Certificate")
