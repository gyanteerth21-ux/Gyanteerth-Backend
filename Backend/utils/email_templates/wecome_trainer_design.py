def welcome_trainer_template(trainer_name: str, trainer_email: str, trainer_password: str):
...
<h2 style="margin:0;color:#222;font-size:24px;">Welcome to Gyanteerth 🎉</h2>

<p style="color:#666;font-size:15px;margin-top:12px;line-height:1.6;">
Dear <b>{trainer_name}</b>, <br><br>

We are delighted to welcome you as a <b>Trainer at Gyanteerth</b>.  
Your expertise and knowledge will play an important role in helping learners grow and succeed on our platform.
</p>
</td>
</tr>
...
<p style="margin:0 0 10px 0;"><b>Your Trainer Login Credentials</b></p>

<p style="margin:6px 0;">
<strong>Email:</strong> {trainer_email}
</p>

<p style="margin:6px 0;">
<strong>Temporary Password:</strong> {trainer_password}
</p>
